package jp.teckacademy.yuka.komaki.taskapp2
...
import jp.teckacademy.yuka.komaki.taskapp2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button1.setOnClickListener{
            val cat = binding.editText.text
            val tasks =realm.query<Task>("category = $0",cat.toString()).find()
